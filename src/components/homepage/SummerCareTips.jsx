...
const SummerCareTips = () => {
    return (
        <div className='bg-[#FFF8F1] py-20'>
            <div className="my-20 container  lg:w-full w-[90%] mx-auto space-y-6">
    <div className='space-y-4'>
      <h2 className="lg:text-6xl md:text-5xl text-4xl font-bold">Summer Care <span className="text-[#D4924A]">Tips</span></h2>
    ...
    <div className="grid lg:grid-cols-3 space-y-4 gap-8  md:grid-cols-2 grid-cols-1">
      <div className="text-center shadow border border-gray-200 hover:border-[#D4924A] p-15 rounded-xl space-y-4">
      ...
      <div className="text-center h-76 shadow border border-gray-200 hover:border-[#D4924A] p-15 rounded-xl space-y-4">
        <div className='text-5xl'>🌊</div>
